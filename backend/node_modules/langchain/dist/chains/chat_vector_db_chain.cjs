...
class ChatVectorDBQAChain extends base_js_1.BaseChain {
    ...
    static fromLLM(llm, vectorstore, options = {}) {
        ...
        const question_generator_prompt = prompts_1.PromptTemplate.fromTemplate(questionGeneratorTemplate || question_generator_template);
        const qa_prompt = prompts_1.PromptTemplate.fromTemplate(qaTemplate || qa_template);
