...
declare type RequireSpecificKeys<T, K extends keyof T> = T & {
    [P in K]-?: T[P];
};
export declare type GraphQLInstrumentationParsedConfig = RequireSpecificKeys<GraphQLInstrumentationConfig, 'mergeItems' | 'depth' | 'allowValues' | 'ignoreResolveSpans'>;
export {};
