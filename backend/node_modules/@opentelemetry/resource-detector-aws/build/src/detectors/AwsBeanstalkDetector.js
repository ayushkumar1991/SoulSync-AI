...
const AwsBeanstalkDetectorSync_1 = require("./AwsBeanstalkDetectorSync");
/**
...
class AwsBeanstalkDetector {
    detect(config) {
        return Promise.resolve(AwsBeanstalkDetectorSync_1.awsBeanstalkDetectorSync.detect(config));
    }
}
